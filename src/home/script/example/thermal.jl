export thermal,thermal!,ic_thermal 
...
```
"""
function ic_thermal(L,nel; fid::String=first(splitext(basename(@__FILE__))), kwargs...)
...
```
"""
function thermal(ic::NamedTuple,cfg::NamedTuple; workflow::String="elastodynamic")
