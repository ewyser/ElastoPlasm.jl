...
```
"""
function export_setup(mesh::Mesh,mpts::Point,cmpr,time::Time,solver::S,paths,misc; path::String = " ", file::String = "simulation_setup") where {T1<:Integer,T2<:Real,D<:AbstractDimension, S<:AbstractSolver{T1,T2,D}}
