...
`PointSolidPhase{T1,T2,D,CM,TM,TV,TS,ST,SM,SC,SK}`, i.e. the type of `mpts.s` — reusing
...
"""
struct MechanicalProblem{T1,T2,D,CM<:AbstractConstitutiveModel{T2,D},TM,TV,TS,ST<:AbstractStrain,SM<:AbstractSolid,SC<:AbstractStress,SK<:AbstractStress} <: AbstractProblem{T1,T2,D,PointSolidPhase{T1,T2,D,CM,TM,TV,TS,ST,SM,SC,SK}}
    mesh ::Mesh{T1,T2,D}
